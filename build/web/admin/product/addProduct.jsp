      ...
      <form action="${pageContext.request.contextPath}/admin/manage-product" method="POST">
        ...
        <div class="row mb-3">
          <div class="col-md-4">
            ...
            <input type="number" class="form-control" id="purchasePrice" name="purchasePrice" step="any">
          </div>
          <div class="col-md-4">
            <label for="salePrice" class="form-label">Giá Bán</label>
            <input type="number" class="form-control" id="salePrice" name="salePrice" step="any">
          </div>
          <div class="col-md-4">
