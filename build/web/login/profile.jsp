              ...
              <form action="${pageContext.request.contextPath}/profile" method="post">
                ...
                <div class="mb-3">
                  ...
                  <select name="role" class="form-select" required>
                    <option value="warehouse_staff" ${user.role == 'WAREHOUSE_STAFF' ? 'selected' : ''}>Nhân viên kho</option>
                    <option value="sales_staff" ${user.role == 'SALES_STAFF' ? 'selected' : ''}>Nhân viên bán hàng</option>
                    <option value="purchasing_staff" ${user.role == 'PURCHASING_STAFF' ? 'selected' : ''}>Nhân viên mua hàng</option>
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" value="<fmt:formatDate value='${user.createdAtAsDate}' pattern='dd/MM/yyyy HH:mm'/>" readonly>
                </div>
