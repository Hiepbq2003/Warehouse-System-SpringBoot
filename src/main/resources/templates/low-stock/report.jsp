                                ...
                                <div class="col-md-6">
                                    <div class="text-md-end">
                                        ...
                                        <small class="text-muted">
                                            Cập nhật: <fmt:formatDate value="<%= new java.util.Date() %>"
                        ...
                        <form method="GET" action="${pageContext.request.contextPath}/low-stock-report">
                            <div class="input-group">
                                <select name="sortBy" class="form-select">
                                    <option value="quantity" ${currentSortBy == 'quantity' ? 'selected' : ''}>Số lượng
                                        tăng dần
                                    </option>
                                    <option value="product_name" ${currentSortBy == 'product_name' ? 'selected' : ''}>
                                        Tên sản phẩm A-Z
                                    </option>
                                    <option value="threshold" ${currentSortBy == 'threshold' ? 'selected' : ''}>Ngưỡng
                                        cảnh báo
                                    </option>
                                </select>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="mb-0">
                            ...
                            <li><span class="badge bg-warning">Sắp hết hàng</span> - Sản phẩm có số lượng ≤ ngưỡng cảnh
                                báo
                            </li>
                            <li>Báo cáo được cập nhật theo thời gian thực từ hệ thống quản lý kho</li>
                            <li>Khuyến nghị: Tạo yêu cầu mua hàng cho các sản phẩm sắp hết hàng để tránh gián đoạn kinh
                                doanh
                            </li>
                        </ul>
                    </div>
