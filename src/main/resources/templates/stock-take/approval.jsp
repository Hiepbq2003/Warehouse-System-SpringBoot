        ...
        <main class="col-md-10 px-md-4 py-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-muted mb-0">Phiếu: ${stockTake.stockTakeCode} - Ngày: <fmt:formatDate
                            value="${stockTake.stockTakeDate}" pattern="dd/MM/yyyy HH:mm"/></p>
                </div>
                <div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach var="detail" items="${discrepancies}">
                                            <c:set var="diff"
                                                   value="${detail.countedQuantity - detail.systemQuantity}"/>
                                                ...
                                                <td class="text-center">
                                                    <c:if test="${detail.systemQuantity > 0}">
                                                        <c:set var="percentage"
                                                               value="${diff * 100 / detail.systemQuantity}"/>
                                                        <span class="badge ${Math.abs(percentage) > 10 ? 'bg-danger' : 'bg-warning'}">
                                                                <fmt:formatNumber value="${percentage}"
                                                                                  maxFractionDigits="1"/>%
                                                            </span>
                                                    </c:if>
                                                </td>
                        ...
                        <div class="card border-success">
                            ...
                            <div class="card-body">
                                <form id="reconcileForm" method="POST"
                                      action="${pageContext.request.contextPath}/stock-take">
                                    ...
                                    <div class="mb-3">
                                        <div class="alert alert-info">
                                            ...
                                            <strong>Lưu ý:</strong> Việc điều chỉnh tồn kho sẽ cập nhật số lượng trong
                                            inventory theo số lượng kiểm đếm thực tế.
                                            <c:if test="${not empty discrepancies}">
                                                <br><strong>Sẽ điều chỉnh ${discrepancies.size()} sản phẩm có chênh
                                                lệch.</strong>
                                            </c:if>
                                        </div>
                                    </div>
                ...
                <div class="row mt-4">
                    <div class="col-12">
                        <div class="alert alert-success text-center" role="alert">
                            ...
                            <p class="mb-0">Tất cả sản phẩm đều khớp với số lượng hệ thống. Không cần điều chỉnh tồn
                                kho!</p>
                        </div>
                    </div>
                </div>
